...
structurizr-cli push -url http://localhost:8088/api -id 1 -key 71b9ed19-3b95-41e2-845d-54b7dda3618d -secret 8c43d9cc-b551-4bb6-95e7-2f172baef35f -workspace workspace.dsl
```

#### Push to Workspace ID: 2
```bash
structurizr-cli validate -workspace workspace.dsl
structurizr-cli push -url http://localhost:8088/api -id 2 -key 033527c5-49fc-4010-8a3f-0dd9dbb80b0c -secret 72ae07cc-c959-43b2-babf-fe417191ce55 -workspace workspace.dsl
```

#### Push to Workspace ID: 3
```bash
structurizr-cli validate -workspace workspace.dsl
structurizr-cli push -url http://localhost:8088/api -id 3 -key 689b237e-fc7b-47ed-bc1b-fc3589a2b273 -secret d17ea158-6782-4194-9853-9f48070c1293 -workspace workspace.dsl
```

#### Push to Workspace ID: 4
```bash
structurizr-cli validate -workspace workspace.dsl
structurizr-cli push -url http://localhost:8088/api -id 4 -key 89d6949a-1db6-4788-aa97-cfe56d1fd50d -secret 74ad006d-0e8f-4329-be33-6cf7a73e5186 -workspace workspace.dsl
```

#### Push to Workspace ID: 5
```bash
structurizr-cli validate -workspace workspace.dsl
structurizr-cli push -url http://localhost:8088/api -id 5 -key a0555cd0-4f00-4182-bead-59bcf599c5e8 -secret 0f177bf2-a83e-4a1
...
```bash
structurizr-cli validate -workspace workspace.dsl
structurizr-cli push -url http://localhost:8088/api -id 6 -key bc2a804e-bd1c-4354-a0df-f8ec38812e32 -secret 231c8c68-f8f4-4df6-8739-54baf56ba35a -workspace workspace.dsl
```
